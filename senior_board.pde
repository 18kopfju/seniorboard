...
text("1,5,9,11,15,36,55,56",840,343);
text("50",900,470);
...
text("Oh The Places You'll Go", 210 , 100);
 ...
 text("3.    Jack Beaty- Lyndon State College",x,y+50);
...
text("31.  Justin Kopf- Xavier University",x,y+750);
 ...
 text("45.  Andrew Pierce",x,y+1100);         
